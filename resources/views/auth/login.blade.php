...
<div class="row justify-content-center">
    <div class="col-11 col-sm-9 col-md-7 col-lg-5 col-xl-4">
        ...
        <div class="text-center text-white mb-4">
            <span class="brand-mark mx-auto mb-3" style="width:56px;height:56px;font-size:1.05rem">
                {{ config('attendance.university_short_name') }}
            </span>
            <h1 class="h4 fw-semibold mb-1">{{ config('attendance.university_name') }}</h1>
            <p class="text-white-50 mb-0">Student Attendance Management System</p>
        </div>
        ...
        <p class="text-center text-white-50 small mt-4 mb-0">
            Accounts are issued by the university registry.<br>
            Contact your faculty office if you cannot sign in.
        </p>
    </div>
</div>
@endsection
